...
const data =
{
    wfm: {
        ...
        achievements: `<ul> <li>Implemented <strong>SSIS packages</strong> for seamless loading of Retro, ATB, Recon, Update, Invoice, Zero Balance & Valid files, streamlining file processing and enabling efficient note creation and file closure.</li> <li>Developed and optimized <strong>stored procedures</strong> to enhance performance and efficiency in account-related activities, facilitating smoother data processing and retrieval.</li> <li>Designed and implemented new <strong>ASP.NET pages</strong> to support critical functionalities including activity code management, user administration, worklist management, and production reporting, improving overall system usability and functionality.</li> <li>Successfully onboarded key clients such as <strong>Triity Mediquant</strong>, <strong>AMG Antrim Lab</strong>, and <strong>Kaiser</strong>, streamlining business operations and enhancing client satisfaction.</li> <li>Spearheaded the onboarding process for physician clients including <strong>Kaweah</strong>, <strong>Archwell</strong>, and <strong>Intuitive Health</strong>, facilitating seamless integration and improving operational efficiency.</li> <li>Addressed client pain points by transitioning from manual Excel-based processes to automated <strong>Workforce Management (WFM) system</strong>, eliminating errors and delays in account management and production reporting.</li> <li>Delivered significant cost and time savings for clients through the implementation of <strong>WFM</strong>, resulting in increased productivity for analysts and supervisors, and ensuring accurate and timely production reporting for finance teams.</li> </ul>`,
